...
class PlatformRegistry:
    ...
    PLATFORMS: Dict[str, Dict[str, Any]] = {
        ...
        "JU": {
            ...
            "category": "IDE Native Agent",
            "default_ext": "json",
        },
        "WS": {
            "name": "Windsurf (Codeium)",
            "category": "Agentic Flow IDE",
            "default_ext": "json",
        },
        "DV": {
        ...
        "RP": {
            "name": "Replit Agent",
            "category": "Cloud Agent & IDE",
            "default_ext": "json",
        },
        "AR": {
            "name": "Agoragentic (ACRE)",
            "category": "Agent Marketplace",
            "default_ext": "json",
        },
        "AU": {
            "name": "Auggie CLI (Augment)",
            "category": "Agent CLI",
            "default_ext": "json",
        },
        "AH": {
        ...
        "CB": {
            "name": "Codebuddy (Tencent Cloud)",
            "category": "Intelligent Coding Tool",
            "default_ext": "json",
        },
        "CT": {
            "name": "Cortex Code (Snowflake)",
            "category": "Enterprise Coding Agent",
            "default_ext": "json",
        },
        "CW": {
            "name": "crow-cli",
            "category": "ACP Native Agent",
            "default_ext": "json",
        },
        "DA": {
        ...
        "DM": {
            "name": "DimCode (ArcShips)",
            "category": "Multi-Model Agent",
            "default_ext": "json",
        },
        "DC": {
            "name": "Dirac (Delta Labs)",
            "category": "Optimized Coding Agent",
            "default_ext": "json",
        },
        "FD": {
            "name": "Factory Droid",
        ...
        "GO": {
            "name": "goose (Block)",
            "category": "Open-Source Extensible Agent",
            "default_ext": "json",
        },
        "GB": {
            "name": "Grok Build (xAI)",
        ...
        "KM": {
            "name": "Kimi CLI (Moonshot AI)",
            "category": "Long-Context Agent",
            "default_ext": "json",
        },
        "MC": {
            "name": "Minion Code (femto)",
            "category": "Coding Assistant",
            "default_ext": "json",
        },
        "MV": {
            "name": "Mistral Vibe",
            "category": "Open-Source Assistant",
            "default_ext": "json",
        },
        "NV": {
            "name": "Nova (Compass AI)",
            "category": "Autonomous Software Engineer",
            "default_ext": "json",
        },
        "OC": {
            "name": "OpenCode (Anomaly)",
            "category": "Open-Source Coding Agent",
            "default_ext": "json",
        },
        "PA": {
            "name": "pi ACP",
            "category": "ACP Adapter Agent",
            "default_ext": "json",
        },
        "PS": {
            "name": "Poolside",
            "category": "Foundation Coding Agent",
            "default_ext": "json",
        },
        "QD": {
            "name": "Qoder CLI",
        ...
        "QW": {
            ...
            "category": "Open Weights Coding Agent",
            "default_ext": "json",
        },
        "SG": {
            "name": "siGit Code",
            "category": "Local-First Coding Agent",
            "default_ext": "json",
        },
        "SP": {
            "name": "Stakpak",
            "category": "Rust DevOps Agent",
            "default_ext": "json",
        },
        # Frontier Web & Conversational LLMs
        "CG": {
            "name": "OpenAI ChatGPT",
            "category": "Frontier Web / Desktop",
            "default_ext": "json",
        },
        "CL": {
            "name": "Anthropic Claude Web / Artifacts",
            "category": "Frontier Web",
            "default_ext": "json",
        },
        "XG": {
        ...
        "VO": {
            "name": "v0 by Vercel",
            "category": "Generative UI Agent",
            "default_ext": "json",
        },
        "PO": {
            "name": "Poe (Quora)",
            "category": "Multi-Bot Hub",
            "default_ext": "json",
        },
        "GS": {
            "name": "Google AI Studio",
            "category": "Prompt Prototyping Lab",
            "default_ext": "json",
        },
        # Local Inference & Offline Hubs
        "OL": {
            "name": "Ollama",
            "category": "Local LLM Runner & CLI",
            "default_ext": "json",
        },
        "LM": {"name": "LM Studio", "category": "Local LLM GUI", "default_ext": "json"},
        "HC": {
            "name": "HuggingChat",
            "category": "Open LLM Web Hub",
            "default_ext": "json",
        },
        "PC": {
            "name": "Pieces for Developers",
            "category": "Workstream Context AI",
            "default_ext": "json",
        },
    }
